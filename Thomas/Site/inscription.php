      ...
      if (isset($_POST['submit']))
      {
        echo ($_POST['question']);
         /* on test si les champ sont bien remplis */
          if(!empty($_POST['nom']) and !empty($_POST['prenom']) and !empty($_POST['mail']) and !empty($_POST['pass']) and !empty($_POST['pass2']) and !empty($_POST['age']) and !empty($_POST['pays']) and !empty($_POST['question']))
          {   
              /* on test si le mdp contient bien au moins 6 caractère */
              if (($_POST['age'])>1 and ($_POST['pass'])<99){
              if (strlen($_POST['pass'])>=6)
              {
                  ...
                  if ($_POST['pass']==$_POST['pass2'])
                  {
                      ...
                      VALUES 
                      ('".$_POST['nom']."','".$_POST['prenom']."','".$_POST['mail']."','".$_POST['pass']."','".$_POST['age']."','".$_POST['pays']."','".$_POST['question']."')";
            ...
            else echo "Veuillez rentrer une valeur correcte !";
          }
...
$query="SELECT * FROM utilisateurs;"; // Requête MySQL a exécuter
//Exécution de la requête
//Retourne les résultats dans result
$result=$con -> query($query);
//Extrait une ligne des résultats
if(!$result)
{
  echo "La requête ne retourne aucune valeur";
}
else 
{
